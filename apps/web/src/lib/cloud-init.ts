...
export function generateCloudInitScript(params: CloudInitParams): string {
  ...
  add('  gateway: (.gateway // {} | . + {mode:"local",host:"0.0.0.0",auth:{mode:"token",token:$token},controlUi:{basePath:"/chat",allowInsecureAuth:true},trustedProxies:["127.0.0.1","::1","172.16.0.0/12","10.0.0.0/8"]}),');
